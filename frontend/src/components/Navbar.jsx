...
function Navbar() {
  ...
  return (<>
   <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0  z-50${
    sticky?"sticky-navbar shadow-md bg-base-200 dark:bg-slate-800 dark:text-white duration-100 transition-all ease-in-out":""
   }`} >
  ...
  <div className="navbar-start">
    ...
    <a className=" text-xl md:text-2xl font-bold cursor-pointer">Driver Service</a>
  </div>
  ...
  <div className="">
    <a className="bg-black text-white px-3 py-2 rounded-md hover:bg-red-800 duration-300 cursor-pointer" onClick={()=> document.getElementById("my_modal_3").showModal()}>Login</a>
    <Login/>
  </div>
</div>
</div>
